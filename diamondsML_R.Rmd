...
output:
  ...
  html_document:
    keep_md: yes
>>>>>>> cd1ef7f67d0e93b72ac4be4d8420e7f0302e62cc
---
...
```{r}
varImpPlot(diamond.RandomForest)
```
## MODEL EVALUATION
...
par(mfrow=c(1,1))
plot(diamond.test$price, diamond.Linear.predictions)
```
```{r}
